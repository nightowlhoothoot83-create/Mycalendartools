...
if (!fs.existsSync('functions/api/geocode.js') || !fs.existsSync('functions/api/tides.js') || !tidePage.includes('/api/geocode?q=') || !tidePage.includes('/api/tides?lat=')) fail.push('tides: same-origin geocoding and marine-data proxies missing');
